...
function AlitaStationSequence.buildDag(dag)
    ...
    DUTInitialization = dag.add(
        ...
        "J314DutIOInitialization.lua", --Action file
        {"dut"}, --plugins
        {
    ...
    ATCHDMIDisplayPattern4K = dag.add(
        "ATCHDMIDisplayPattern4K", --Burgundy Test Name
        "ATCHDMIDisplayPatternTest.lua", --Action file
        {"titaniumHDMI","dut"}, --plugins
        {
            ["TestName"] = "ATCHDMIDisplayPattern4K", --TestName
            ["portIdentifier"] = "HDMI" --PortIdentifier
        } 
    )

    HDMI4kTestBoxEyeCapture = dag.add(
        "HDMI4kTestBoxEyeCapture", --Burgundy Test Name
        "HDMITestBoxEyeCaptureTest.lua", --Action file
        {"titaniumHDMI"}, --plugins
        {
            ["TestName"] = "HDMI4kTestBoxEyeCapture", --TestName
            ["portIdentifier"] = "HDMI" --PortIdentifier
        } 
    )

    ATCHDMIphyTurnOff = dag.add(
        "ATCHDMIphyTurnOff", --Burgundy Test Name
        "SendCommandToDUT.lua", --Action file
        {"dut"}, --plugins
        {
            ["TestName"] = "ATCHDMIphyTurnOff", --TestName
            ["portIdentifier"] = "HDMI" --PortIdentifier
        } 
    )
    ...
    CPort0CIO20GTunableCheck_314 = dag.add(
        "CPort0CIO20GTunableCheck_314", --Burgundy Test Name
        "RegisterCheckTest.lua", --Action file
        {"dut"}, --plugins
        {
            ["TestName"] = "CPort0CIO20GTunableCheck_314", --TestName
            ["portIdentifier"] = "CPort0UP" --PortIdentifier
        } 
    )

    CPort1CIO20GTunableCheck_314 = dag.add(
        "CPort1CIO20GTunableCheck_314", --Burgundy Test Name
        "RegisterCheckTest.lua", --Action file
        {"dut"}, --plugins
        {
            ["TestName"] = "CPort1CIO20GTunableCheck_314", --TestName
            ["portIdentifier"] = "CPort1UP" --PortIdentifier
        } 
    )

    CPort2CIO20GTunableCheck_314 = dag.add(
        "CPort2CIO20GTunableCheck_314", --Burgundy Test Name
        "RegisterCheckTest.lua", --Action file
        {"dut"}, --plugins
        {
            ["TestName"] = "CPort2CIO20GTunableCheck_314", --TestName
            ["portIdentifier"] = "CPort2UP" --PortIdentifier
        } 
    )
    ...
    DUTCleanup = dag.add(
        ...
        "J314DutIOCleanup.lua", --Action file
        {"dut"}, --plugins
        {
    ...
    CPort0USB5GTunableCheck_314 = dag.add(
        "CPort0USB5GTunableCheck_314", --Burgundy Test Name
        "RegisterCheckTest.lua", --Action file
        {"dut"}, --plugins
        {
            ["TestName"] = "CPort0USB5GTunableCheck_314", --TestName
            ["portIdentifier"] = "CPort0DOWN" --PortIdentifier
        } 
    )

    CPort1USB5GTunableCheck_314 = dag.add(
        "CPort1USB5GTunableCheck_314", --Burgundy Test Name
        "RegisterCheckTest.lua", --Action file
        {"dut"}, --plugins
        {
            ["TestName"] = "CPort1USB5GTunableCheck_314", --TestName
            ["portIdentifier"] = "CPort1DOWN" --PortIdentifier
        } 
    )

    CPort2USB5GTunableCheck_314 = dag.add(
        "CPort2USB5GTunableCheck_314", --Burgundy Test Name
        "RegisterCheckTest.lua", --Action file
        {"dut"}, --plugins
        {
            ["TestName"] = "CPort2USB5GTunableCheck_314", --TestName
            ["portIdentifier"] = "CPort2DOWN" --PortIdentifier
        } 
    )

    
    CPort0USB10GTunableCheck_314 = dag.add(
        "CPort0USB10GTunableCheck_314", --Burgundy Test Name
        "RegisterCheckTest.lua", --Action file
        {"dut"}, --plugins
        {
            ["TestName"] = "CPort0USB10GTunableCheck_314", --TestName
            ["portIdentifier"] = "CPort0DOWN" --PortIdentifier
        } 
    )

    CPort1USB10GTunableCheck_314 = dag.add(
        "CPort1USB10GTunableCheck_314", --Burgundy Test Name
        "RegisterCheckTest.lua", --Action file
        {"dut"}, --plugins
        {
            ["TestName"] = "CPort1USB10GTunableCheck_314", --TestName
            ["portIdentifier"] = "CPort1DOWN" --PortIdentifier
        } 
    )

    CPort2USB10GTunableCheck_314 = dag.add(
        "CPort2USB10GTunableCheck_314", --Burgundy Test Name
        "RegisterCheckTest.lua", --Action file
        {"dut"}, --plugins
        {
            ["TestName"] = "CPort2USB10GTunableCheck_314", --TestName
            ["portIdentifier"] = "CPort2DOWN" --PortIdentifier
        } 
    )
    ...
    dag.order(CPort2DOWNUsbphyTurnOnHS, SystemDOWNUSBHSPresenceDUTCheck)
    ...
    dag.order(SystemDOWNUSBSSPresenceDUTCheck, CPort0USB5GTunableCheck_314)
    dag.order(CPort0USB5GTunableCheck_314, CPort1USB5GTunableCheck_314)
    dag.order(CPort1USB5GTunableCheck_314, CPort2USB5GTunableCheck_314)

    dag.order(CPort2USB5GTunableCheck_314, CPort0DOWNUsbphyTurnOffSS)
    ...
    dag.order(SystemDOWNUSBSSPPresenceDUTCheck, CPort0USB10GTunableCheck_314)
    dag.order(CPort0USB10GTunableCheck_314, CPort1USB10GTunableCheck_314)
    dag.order(CPort1USB10GTunableCheck_314, CPort2USB10GTunableCheck_314)

    dag.order(CPort2USB10GTunableCheck_314, CPort0DOWNUsbphyTurnOffSSP)
    ...
    dag.order(CPort2UPUsbphyTurnOnHS, SystemUPUSBHSPresenceDUTCheck)
...
--hdmi
    dag.order(CPort2UPUsbphyTurnOffSSP, ATCHDMIDisplayPattern4K)
    dag.order(ATCHDMIDisplayPattern4K, HDMI4kTestBoxEyeCapture)
    dag.order(HDMI4kTestBoxEyeCapture, ATCHDMIphyTurnOff)
    
--native dp
    dag.order(ATCHDMIphyTurnOff, CPort0SwitchTestBoxNativeDP)
    dag.order(ATCHDMIphyTurnOff, CPort1SwitchTestBoxNativeDP)
    dag.order(ATCHDMIphyTurnOff, CPort2SwitchTestBoxNativeDP)
    ...
    dag.order(CPort0DPHBR3DisplayPattern, CPort0UPUsbphyTurnOffDP)

    dag.order(CPort0UPUsbphyTurnOffDP, CPort1DPHBR3DisplayPattern)
    dag.order(CPort1DPHBR3DisplayPattern, CPort1UPUsbphyTurnOffDP)

    dag.order(CPort1UPUsbphyTurnOffDP, CPort2DPHBR3DisplayPattern)
    dag.order(CPort2DPHBR3DisplayPattern, CPort2UPUsbphyTurnOffDP)
...
--tunnel dp
    ...
    dag.order(CPort1UPUsbphyTurnOffTunnelDP, CPort2DPTunnelDisplayPattern)  
    dag.order(CPort2DPTunnelDisplayPattern, CPort2UPUsbphyTurnOffTunnelDP)
...
--cio20
    ...
    dag.order(CPort2CIO20GPresenceTest, CPort0CIO20GTunableCheck_314)
    dag.order(CPort0CIO20GTunableCheck_314, CPort1CIO20GTunableCheck_314)
    dag.order(CPort1CIO20GTunableCheck_314, CPort2CIO20GTunableCheck_314)

    dag.order(CPort2CIO20GTunableCheck_314, SystemUPCIO20GHostEyeTest)
